...
class EditLevelTest(BaseLevelTest):
    ...
    def __init__(self):
        super(EditLevelTest, self).__init__()
        ...
        self.level_data = {
            "name": "Редактированный уровень".decode('utf-8'),
            "first_advantage": "Редактированное преимущество".decode('utf-8'),
            "third_advantage": "Третье Редактированное преимущество".decode('utf-8'),
            "price": "30",
        }
    ...
    def fill_empty_form(self):
        self.edit_page.fill_form(self.level_data[""], self.level_data[""], self.level_data[""])
    ...
    def test_invalid_second_advantage(self):
        ...
        self.assertTrue(self.edit_page.check_advantage(2))
        self.edit_page.set_level_advantage("", 2)
