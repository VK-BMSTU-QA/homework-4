...
![изображение](https://user-images.githubusercontent.com/48956541/166328883-df37b133-dd5e-4ea8-967e-078845f99f35.png)

- [ ] Ввести "Первый уровень" в текстовое поле `Название уровня`
- [ ] Ввести "Хорошее преимущество" в текстовое поле `Название преимущества`
- [ ] Нажать на кнопку `Заменить обложку` и загрузить обложку с размером файла больше 20 МБ
- [ ] Убедиться в появлении текста об ошибки загрузки изображения
- [ ] Нажать на кнопку `Заменить обложку` и загрузить обложку записи с размером файла 3 МБ
- [ ] Убедиться в смене картинки обложки изображения на загруженную
...
- [ ] Убедиться в появлении текста об ошибки о некоректном значении поля
...
![изображение](https://user-images.githubusercontent.com/48956541/166329047-ddb6bdfd-687c-4053-bc2f-bf46f5af03c0.png)
...
- [ ] Ввести "Привет мир" в текстовое поле `Стоимость подписки в месяц, рубли`
- [ ] Убедиться в появлении текста об ошибки об некоректном значении поля
