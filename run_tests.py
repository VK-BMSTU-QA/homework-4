...
def suite():
    ...
    #suite.addTest(Basket('test_basket_refresh')) удалены
    #suite.addTest(Basket('test_basket_delete_product')) удалены
    suite.addTest(Basket('test_basket_empty'))
    #suite.addTest(Basket('test_basket_increase_in_basket'))  удалены
